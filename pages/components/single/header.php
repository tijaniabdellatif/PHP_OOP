    ...
    <div class="container mx-auto flex items-center">
        <div class="flex text-white font-extrabold">
            <a class="flex text-white text-base no-underline hover:text-white hover:no-underline" href="#">
                👻 <span class="hidden w-0 md:w-auto md:block pl-1">Ghost Blog</span>
            </a>
        </div>
        <div class="flex pl-4 text-sm">
            <ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
                <li class="mr-2">
                    <a class="inline-block py-2 px-2 text-white no-underline hover:text-yellow-500" href="<?= URL ?>index.php">HOME</a>
                </li>
                
                    <li class="mr-2">
                        <a class="inline-block text-white no-underline cursor-pointer hover:text-yellow-500 py-2 px-2"><?= $post->title;  ?></a>
                    </li>
