<div class="container px-4 md:px-0 max-w-6xl mx-auto -mt-32">
    ...
    <div class="mx-0 sm:mx-6">
                ...
                <div class="flex w-1/2 pl-4 text-sm">
                    ...
                    <ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
                        <?php foreach ($post as $p) : ?>
                            <li class="flex flex-col items-center my-2">
                                <a class="inline-block text-2xl py-2 px-2 text-white no-underline hover:text-yellow-500" href="<?= $p->url; ?>"><?= $p->title; ?></a>
                                <span class="text-gray-300 text-sm"><?= $p->category_name ?></span>
                            </li>
        ...
        <div class="bg-gray-200 w-full text-xl md:text-2xl text-gray-800 leading-normal rounded-t">
            ...
            <!--Lead Card-->
            <!-- <div class="flex h-full bg-white rounded overflow-hidden shadow-lg test">
                        ...
                        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                            <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                                <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                                    ...
                                    <p class="w-full text-gray-600 text-xs md:text-sm px-6"><?= $po->title ?></p>
                                    <div class="w-full  font-bold text-xl text-gray-900 px-6"><?= $po->slug; ?></div>
                                    <p class="text-gray-800 font-serif text-base text-justify px-6 mb-5">
                                        <?= $po->extrait; ?>
                            ...
                            <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow-lg p-6">
                                <div class="flex items-center justify-between">
                                    <img class="w-8 h-8 rounded-full mr-4 avatar" data-tippy-content="<?= $po->author ?>" src="http://i.pravatar.cc/300" alt="Avatar of Author">
                                    <p class="text-gray-600 text-xs md:text-sm"><?= createArray(' ', $po->date) ?></p>
                                </div>
                            </div>
                        </div>
...
<!--  -->
                ...
                <div class="w-full md:w-1/2 p-6 flex flex-col flex-grow flex-shrink">
                    ...
                    <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow-lg p-6">
                        <div class="flex items-center justify-between">
                            <img class="w-8 h-8 rounded-full mr-4 avatar" data-tippy-content="" src="http://i.pravatar.cc/300" alt="Avatar of Author">
                            <p class="text-gray-600 text-xs md:text-sm">1 MIN READ</p>
                        </div>
                    </div>
                </div>
